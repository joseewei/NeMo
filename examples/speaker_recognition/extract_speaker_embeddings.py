...
def main():
    ...
    if args.model_path.endswith('.nemo'):
        ...
        speaker_model = ExtractSpeakerEmbeddingsModel.load_from_checkpoint(args.model_path)
        logging.info(f"using pretrained speaker verification model from NGC - nithin")
