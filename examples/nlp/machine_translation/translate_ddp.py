...
from nemo.collections.nlp.data.machine_translation import TranslationOneSideDataset, TranslationDataset
...
def get_args():
    ...
    parser.add_argument("--load_from_cached_dataset", action="store_true")
...
def translate(rank, world_size, args):
    ...
    if args.twoside:
        ...
        if args.load_from_cached_dataset:
            dataset = pickle.load(open(args.text2translate, 'rb'))
        else:
